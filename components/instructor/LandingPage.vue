                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input
                            :value="course.title"
                            @input="
                                ($event) => emitCourseValue($event, 'title')
                            "
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input
                            ...
                            @input="
                                ($event) => emitCourseValue($event, 'subtitle')
                            "
                            class="input is-medium"
                            type="text"
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <textarea
                            ...
                            @input="
                                ($event) =>
                                    emitCourseValue($event, 'description')
                            "
                ...
                <div class="field">
                    ...
                    <div class="select is-medium">
                        <select
                            ...
                            @change="
                                ($event) => emitCourseValue($event, 'category')
                            "
                        >
                            <option
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input
                            ...
                            @input="
                                ($event) =>
                                    emitCourseValue($event, 'productLink')
                            "
                            class="input is-medium"
                            type="text"
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input
                            ...
                            @input="
                                ($event) =>
                                    emitCourseValue($event, 'promoVideoLink')
                            "
                            class="input is-medium"
                            type="text"
